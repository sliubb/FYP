...
*使用方法：
  ...
  */
  ...
  //------------------ 变量定义 ---------------------------//
  var tiannetYearSt = 2020;//可选择的开始年份
  var tiannetYearEnd = 2040;//可选择的结束年份
  ...
  // ---------------------- end 用户可调用的函数 -----------------------------//
  //------------------ begin 页面显示部分 ---------------------------//
  var weekName = new Array("Sun","Mon","Tue","Wes","Thu","Fri","Sat");
  document.write('<div id="divTiannetDate" style="'+s_tiannet_body+'" style="try">');
  ...
  'onclick="spanHourCEvent();"> Hour</span>');
  ...
  'this.style.display=\'none\';">');
  for(var i=0;i <= 59;i ++){
  document.writeln('<option value="' + i + '">' + i + 'Min</option>');
  }
  document.write('</select>');
  document.write('</div>');
  //输出一条横线
  ...
  document.write('<input type="button" style="'+s_tiannet_turn+'" value="Y<-" title="Pre" onClick="tiannetPrevYear();">');
  document.write('<input type="button" style="'+s_tiannet_turn+'" value="Y->" title="Next" onClick="tiannetNextYear();"> ');
  document.write('<input type="button" style="'+s_tiannet_turn+'" value="M<-" title="Pre" onClick="tiannetPrevMonth();">');
  document.write('<input type="button" style="'+s_tiannet_turn+'" value="M->" title="Next" onClick="tiannetNextMonth();">');
  document.write('</div>');
  //输出一条横线
  document.write('<div style="'+s_tiannet_line+'"></div>');
  ...
  +' style="' + s_tiannet_day + '"> </td>');
  document.write('<td align="right" colspan="5"><a href="javascript:tiannetClear();" style="' + s_tiannet_link + '">clear</a>'+
  ' <a href="javascript:tiannetHideControl();" style="' + s_tiannet_link + '">close</a>' +
  ' <a href="javascript:tiannetSetValue(true);" style="' + s_tiannet_link + '">yes</a> ' +
  '</td>');
  document.write (' </tr>');
  document.write('</table>');
  document.write('</div>');
  ...
  else{alert("our of range（1000-9999）！");}
  ...
  if(tiannetYear > 999 && tiannetYear <10000){tiannetYear++;}
  else{alert("out of range（1000-9999）！");return;}
  tiannetSetDay(tiannetYear,tiannetMonth);
  ...
  if( m_bolShowMinute ) document.all.tiannetMinuteHead.innerText = tiannetMinute + "Minutes";
